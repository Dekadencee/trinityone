...
enum RBACPermissions
{
    ...
    RBAC_PERM_COMMAND_REUSE1                                 = 230,
    RBAC_PERM_COMMAND_REUSE2                                 = 231,
    ...
    RBAC_PERM_COMMANDS_REUSE5                                = 609,
    RBAC_PERM_COMMANDS_REUSE6                                = 610,
    RBAC_PERM_COMMANDS_RELOAD_ALL                            = 611,
    RBAC_PERM_COMMANDS_REUSE7                                = 612,
